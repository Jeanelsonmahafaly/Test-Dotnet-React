		...
		extend: {
			colors: {
				...
				'in-progress': {
					...
					border: 'hsl(var(--in-progress-border))',
					accent: 'hsl(var(--in-progress-accent))'
				},
				done: {
					DEFAULT: 'hsl(var(--done))',
					border: 'hsl(var(--done-border))',
					accent: 'hsl(var(--done-accent))'
				}
			},
			backgroundImage: {
				'gradient-primary': 'var(--gradient-primary)',
				'gradient-todo': 'var(--gradient-todo)',
				'gradient-progress': 'var(--gradient-progress)',
				'gradient-done': 'var(--gradient-done)'
			},
			boxShadow: {
